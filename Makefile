...
PREFIX=/home/jan/voip_compile/opalvoip-cvs/ptlib-2.10.9
exec_prefix = ${PREFIX}
export LIBDIR=${exec_prefix}/lib_linux_x86_64
export PTLIBDIR=/home/jan/voip_compile/opalvoip-cvs/ptlib-2.10.9
...
ifeq (,$(findstring $(OSTYPE),Darwin cygwin mingw))
  LIB_SONAME   = $(PTLIB_FILE).2.10.9
  DEBUG_SONAME = $(PTLIB_DEBUG_FILE).2.10.9
else
  LIB_SONAME   = $(subst .$(LIB_SUFFIX),.2.10.9.$(LIB_SUFFIX),$(PTLIB_FILE))
  DEBUG_SONAME = $(subst .$(LIB_SUFFIX),.2.10.9._d$(LIB_SUFFIX),$(PTLIB_FILE))
endif
